...
**절대적 데이터 격리**: 
- ❌ 다른 업체의 데이터는 **절대로** 조회/수정/삭제할 수 없습니다
- ❌ 다른 작업반장이 등록한 내용은 **절대로** 조회/수정/삭제할 수 없습니다
- ✅ 오직 **등록한 개인(작업반장)**과 **담당 현장 관리 업체(관리자)**만 볼 수 있습니다

### 🛡️ 2025-01-07 보안 강화 사항

다음 보안 취약점을 수정했습니다:

1. **`updateSite` (현장 수정)**: `companyId` 필터 추가 → 다른 업체의 현장 수정 방지
2. **`assignForemenToSite` (작업반장 할당)**: 작업반장 소속 회사 검증 추가 → 다른 업체의 작업반장 할당 방지
